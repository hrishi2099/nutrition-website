        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Contact <span className="text-black">{contactInfo.companyName}</span>
            </h1>
              ...
              {isSubmitted ? (
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                  <div className="flex items-center">
                    <div className="text-black text-2xl mr-3">✓</div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">Thank you for your message!</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black bg-white text-gray-900"
                  ...
                  <button
                    ...
                    className="w-full bg-black text-white py-3 px-6 rounded-lg text-lg font-semibold hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{contactInfo.city}, {contactInfo.state} {contactInfo.zipCode}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900">{contactInfo.mondayFridayHours}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Saturday</span>
                    <span className="text-gray-900">{contactInfo.saturdayHours}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Sunday</span>
                    <span className="text-gray-900">{contactInfo.sundayHours}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex space-x-4">
                    {contactInfo.facebookUrl && (
                      <a href={contactInfo.facebookUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                    ...
                    {contactInfo.twitterUrl && (
                      <a href={contactInfo.twitterUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {contactInfo.instagramUrl && (
                      <a href={contactInfo.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {contactInfo.linkedinUrl && (
                      <a href={contactInfo.linkedinUrl} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors">
                        <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-16 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            ...
            <div className="bg-white p-6 rounded-lg text-left">
              <h3 className="font-semibold text-gray-900 mb-2">Do you accommodate dietary restrictions?</h3>
              <p className="text-gray-600 text-sm">
                Absolutely! We create plans for all dietary needs including vegetarian, vegan, gluten-free, keto, and food allergies.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg text-left">
              <h3 className="font-semibold text-gray-900 mb-2">What&apos;s included in the consultation?</h3>
              <p className="text-gray-600 text-sm">
