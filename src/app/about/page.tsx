            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Personalized Nutrition Plans</h4>
                ...
                <li className="flex items-start">
                  <span className="text-black mr-3 mt-1">✓</span>
                  <div>
                    <h4 className="font-semibold text-gray-900">Expert Consultations</h4>
          ...
          {loading ? (
            ...
            <div className={`grid grid-cols-1 ${teamMembers.length === 2 ? 'md:grid-cols-2' : 'md:grid-cols-3'} gap-8`}>
              {teamMembers.map((member, index) => (
                <AnimatedCard key={member.id} delay={0.1 * (index + 1)} className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition-shadow">
                  ...
                  {member.specialties.length > 0 && (
                    <div className="flex flex-wrap justify-center gap-1 mb-3">
                      {member.specialties.slice(0, 3).map((specialty, idx) => (
                        <span key={idx} className="px-2 py-1 bg-blue-100 /30 text-blue-800 text-xs rounded">
                          {specialty}
                        </span>
                      ))}
                    </div>
                  ...
                  {(member.email || member.linkedIn || member.twitter) && (
                    <div className="flex justify-center space-x-2 mt-3">
                      ...
                      {member.twitter && (
                        <a href={member.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600">
                          🐦
                        </a>
                      )}
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center p-6">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Science-Based</h3>
            ...
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🎯</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Personalized</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🌱</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Sustainable</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center p-6">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Supportive</h3>
              <p className="text-gray-600 text-sm">
