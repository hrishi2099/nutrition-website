...
export default function DietPlan() {
  ...
  const filteredPlans = dietPlans.filter(plan => {
    ...
    const matchesPrice = priceRange === 'all' || 
                        (priceRange === 'free' && plan.price === 0) ||
                        (priceRange === 'budget' && plan.price > 0 && plan.price < 6000) ||
              ...
              >
                ...
                <div className="space-y-2 mb-6">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900">{plan.duration} weeks</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Daily Meals:</span>
                    <span className="font-medium text-gray-900">{plan.mealsPerDay} meals</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Calories:</span>
                    <span className="font-medium text-gray-900">{plan.calories} cal/day</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-500">Type:</span>
                    <span className="font-medium text-gray-900">{getPlanTypeDisplay(plan.type)}</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Mobile App Access</h3>
            ...
            >
              <div className="text-4xl mb-4">👨‍🍳</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Chef-Designed Recipes</h3>
              <p className="text-gray-600 text-sm">
            ...
            >
              <div className="text-4xl mb-4">🛒</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Shopping Lists</h3>
              <p className="text-gray-600 text-sm">
            ...
            >
              <div className="text-4xl mb-4">💬</div>
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Expert Support</h3>
              <p className="text-gray-600 text-sm">
