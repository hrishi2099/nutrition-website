...
const sampleCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    description: 'PDF guides, ebooks, and digital nutrition resources',
    image: '/api/placeholder/300/200',
  },
];
...
const sampleProducts: Product[] = [
  ...
  // PDF Products
  {
    ...
    rating: 4.9,
    reviewCount: 287,
    tags: ['pdf', 'nutrition-guide', 'athletes', 'sports-nutrition'],
    type: 'pdf' as const,
    benefits: [
    ...
    pdfInfo: {
      filePath: '/pdfs/nutrition-guide-athletes.pdf',
      fileName: 'Complete_Nutrition_Guide_Athletes.pdf',
      fileSize: 8500000, // 8.5MB
      pageCount: 50,
      downloadLimit: 5,
      expiryDays: 365,
      author: 'Dr. Sarah Johnson, Sports Nutritionist',
      language: 'English',
      format: 'pdf',
    },
    createdAt: '2024-01-01',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 156,
    tags: ['pdf', 'weight-loss', 'meal-plans', 'recipes'],
    type: 'pdf' as const,
    benefits: [
      'Instant access to 100+ recipes',
    ...
    pdfInfo: {
      filePath: '/pdfs/weight-loss-meal-plan.pdf',
      fileName: 'Weight_Loss_Meal_Plan_Recipe_Book.pdf',
      fileSize: 12000000, // 12MB
      pageCount: 75,
      downloadLimit: 3,
      expiryDays: 180,
      author: 'NutriSap Nutrition Team',
      language: 'English',
      format: 'pdf',
    },
    createdAt: '2024-01-01',
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 93,
    tags: ['pdf', 'supplements', 'stacking', 'guide'],
    type: 'pdf' as const,
    benefits: [
    ...
    pdfInfo: {
      filePath: '/pdfs/supplement-stacking-guide.pdf',
      fileName: 'Supplement_Stacking_Guide.pdf',
      fileSize: 5500000, // 5.5MB
      pageCount: 32,
      downloadLimit: 10,
      expiryDays: 730,
      author: 'Dr. Mike Chen, Nutritionist',
      language: 'English',
      format: 'pdf',
    },
    createdAt: '2024-01-01',
