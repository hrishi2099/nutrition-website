                  ...
                  <div className="mb-4">
                    ...
                    <div className="text-xs text-gray-600">
                      {meal.ingredients.slice(0, 3).map((ingredient) => (
                        <span key={ingredient.id} className="inline-block bg-gray-100 rounded px-2 py-1 mr-1 mb-1">
                          {ingredient.name}
                        </span>
                      ))}
            ...
            >
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="font-medium">Type: <span className={`px-2 py-1 rounded text-sm ${getMealTypeColor(selectedMeal.type)}`}>{selectedMeal.type}</span></p>
                    <p className="font-medium">Diet Plan: {selectedMeal.dietPlan.name}</p>
                  </div>
